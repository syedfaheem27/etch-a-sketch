...
btn_container.style.cssText='display: flex;  justify-content: center;\
...
btn_scale.forEach((btn) => {
    btn.style.cssText='border: 1px solid blue; color: red; padding: 10px;\
    border-radius: 4px;';
});
...
for(let i=0;i<4;i++) {
    ...
    btn_option[i].style.cssText='border: 1px solid blue; color: red; \
    background-color: bisque; padding: 10px; border-radius: 4px;';
